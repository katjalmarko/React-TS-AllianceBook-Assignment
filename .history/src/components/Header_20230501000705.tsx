...
const Header = () => {
  return (
    <div className="flex flex-row justify-center items-center space-x-1 sm:space-x-2 md:space-x-4 mt-2 sm:mt-4 md:mt-8 mb-4 sm:mb-8 md:mb-12">
      ...
      />
      <h1 className="text-white animate-pulse text-xs sm:text-sm md:text-base lg:text-lg xl:text-2xl">
        Character
      </h1>
      <img
        src={Starwars1}
        alt="logo"
        className="h-8 sm:h-16 md:h-16 lg:h-32 xl:h-36"
      />
      <h1 className="text-white animate-pulse text-xs sm:text-sm md:text-lg lg:text-xl xl:text-2xl">
        Database
      </h1>
      <img
        src={Starwars3}
