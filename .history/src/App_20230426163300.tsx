...
const CharacterDetails = () => {
  ...
  return (
    <div>
      <div className="flex justify-center items-center mt-20 ml-20 h-12 w-36 px-4 py-2 rounded-lg bg-gray-800 text-white border-none">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center text-center mt-20 mb-20 text-white">
        ...
        <div className="space-y-2">
          ...
          <p className="animate-type">Height: {character.height}</p>
          <p className="animate-type">Mass: {character.mass}</p>
          <p className="animate-type">Hair Color: {character.hair_color}</p>
          <p className="animate-type">Skin Color: {character.skin_color}</p>
          <p className="animate-type">Eye Color: {character.eye_color}</p>
          <p className="animate-type">Birth Year: {character.birth_year}</p>
          <p className="animate-type">Gender: {character.gender}</p>
        </div>
      </div>
    </div>
  );
