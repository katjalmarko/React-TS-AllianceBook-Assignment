...
export const CardDetails = () => {
  ...
  return (
    <div className="flex" style={{ textShadow: '0 0 10px black' }}>
      <div className="w-full max-w-3xl p-8 mt-10 mb-10 mr-5 ml-5 bg-gray-700/60 border border-white rounded-lg shadow-md text-white">
        <div className="flex flex-col md:flex-row justify-center items-center mt-20 mb-20 text-white">
          <img
            src={photoUrl}
            alt={character.name}
            className="rounded-lg w-48 h-80 md:w-80 mb-8 md:mb-0 md:mr-8"
          />
          <div className="flex flex-col items-center">
            <div className="space-y-2 bg-black p-8 rounded-lg">
              ...
              <p className="font-shojumaru">
                <span className="text-gray-400 mr-4">Hair Color:</span>{' '}
            ...
            <Link
              to={'/'}
              className="flex justify-center items-center p-4 rounded-lg m-5 bg-black backLink"
            >
              Back to Database
            </Link>
          </div>
