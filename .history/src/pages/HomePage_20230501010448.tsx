...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-">
      ...
      {/* Pagination buttons */}
      <div className="mb-8 flex justify-center flex-wrap gap-2 font-wallpoet">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between mx-16 text-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
        <div className="text-base sm:text-lg text-white">
          Current Page :{' '}
          <span className="font-wallpoet text-4xl">{currentPage}</span>
        </div>
        <div className="text-base sm:text-lg text-white">
          Characters :{' '}
          <span className="font-wallpoet text-4xl">{characters.length}</span>
        </div>
      </div>
