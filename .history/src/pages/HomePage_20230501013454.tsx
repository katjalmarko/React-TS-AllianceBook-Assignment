  ...
  <div className="flex flex-col md:flex-row items-center justify-center md:space-x-4 mb-4 mt-4">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between mx-16 text-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
      <div className="text-base sm:text-lg text-white">
        Current Page : <span className='font-crimson font-bold text-3xl animate-pulse'</span>
      </div>
      <div className="text-base sm:text-lg text-white">
        Characters : <span className='font-crimson font-bold text-3xl animate-pulse' style={{ textShadow: '0 0 10px white' }}>{characters.length}</span>
      </div>
    </div>
