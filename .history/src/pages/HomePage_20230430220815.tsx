...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-4 text-2xl text-white font-shojumaru">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mx-6">
        ...
        <div className="mb-4 flex justify-center flex-wrap gap-2">
          {genderFilters.map(gender => (
            <button
              key={gender}
              className={`bg-gray-800 text-white text-smsm:text-base px-2 sm:px-4 py-1 sm:py-2 rounded mx-1 my-1 ${
