...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center text-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
        <div className="text-xl sm:text-2xl text-white">Page {currentPage}</div>
        <div className="text-xl sm:text-2xl text-white font-shojumaru">
