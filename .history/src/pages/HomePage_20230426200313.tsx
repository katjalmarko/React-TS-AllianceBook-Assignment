    ...
    <div className="container mx-auto px-4 py-8">
      <div className="relative w-full">
        <img
          ...
          alt="logo"
          className="h-16 md:h-24 w-auto absolute top-5 left-5"
        />
        <div className="flex flex-col items-center justify-center md:flex-row md:justify-center mt-20 md:mt-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8 text-center md:text-center text-white">
