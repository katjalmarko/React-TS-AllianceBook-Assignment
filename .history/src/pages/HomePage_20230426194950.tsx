    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-center md:justify-start">
        <img
          ...
          alt="logo"
          className="h-24 md:h-16 w-auto absolute top-0 left-0 transform -translate-x-1/2 -translate-y-1/2"
        />
        <h1 className="text-6xl md:text-8xl font-black mb-8 text-center md:text-left text-white">
