...
const HomePage = () => {
  ...
  // Use the useQuery hook to fetch all character data and handle loading and error states
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-4 text-3xl text-white font-shojumaru">
