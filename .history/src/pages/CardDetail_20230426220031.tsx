    ...
    <div className="mx-auto">
      <div className="flex flex-col md:flex-row justify-center items-center text-center mt-20 mb-20 text-white">
        ...
        <div className="flex flex-col">
          <div className="space-y-2 bg-gray-800/60 p-8">
          ...
          <Link className="flex justify-center items-center rounded-lg m-5 bg-gray-800 backLink">
            <Link to={'/'}>Back to Database</Link>
          </Link>
        </div>
      </div>
    </div>
