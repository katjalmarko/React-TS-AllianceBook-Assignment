    ...
    <div className="container mx-auto px-4 py-8">
      <div className="relative">
        <img
          ...
          alt="logo"
          className="h-16 absolute top-0 left-0"
        />
        <h1 className="text-5xl md:text-7xl font-black mb-8 text-center text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:static md:text-left">
