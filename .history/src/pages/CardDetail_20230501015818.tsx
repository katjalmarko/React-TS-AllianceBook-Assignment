...
export const CardDetails = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-center items-center p-8 mt-5 bg-gray-700/60 border border-white rounded-lg shadow-md text-white w-11/12 md:w-2/3 lg:w-1/2">
        <img
          src={photoUrl}
          alt={character.name}
