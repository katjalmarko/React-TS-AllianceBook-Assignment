...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-">
      <div className="flex flex-col md:flex-row lg:items-center items-center justify-center gap-4 md:gap-8">
      ...
      {/* Displays how many characters were found in the database */}
      <div className="text-center text-xl sm:text-2xl text-white font-shojumaru">
        {characters.length} characters
      </div>

      {/* Display character cards */}
      <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-8 mb-2">
