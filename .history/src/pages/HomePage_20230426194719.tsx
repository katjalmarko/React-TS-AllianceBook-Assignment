    ...
    <div className="container mx-auto px-4 py-8">
      <div className="relative">
        <img
          ...
          alt="logo"
          className="h-24 w-auto absolute top-0 left-0 sm:h-12 sm:w-auto md:h-16"
        />
        <div className="flex justify-center items-center h-24 sm:h-auto md:h-32">
          <h1 className="text-6xl font-black mb-8 animate-pulse text-white">
