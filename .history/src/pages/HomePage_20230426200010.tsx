    ...
    <div className="container mx-auto px-4 py-8">
      <div className="relative w-full">
        <img
          ...
          alt="logo"
          className="h-16 md:h-24 w-auto absolute top-5 left-5 mr-10"
        />
        <div className="flex items-center justify-center md:justify-center">
          <h1 className="text-5xl md:text-7xl font-black mt-20 md:mt-0 mb-8 text-center md:text-center text-white">
