...
const HomePage = () => {
  ...
  <img src="../public/images/Starwars.png" alt="logo" class="h-24 w-auto">
  <h1 class="text-6xl font-black mb-8 animate-pulse text-white flex-1 text-center">Star Wars Characters</h1>
</div>
