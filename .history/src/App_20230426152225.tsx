...
Now, the code uses the latest version of react-router-dom and your TypeScript types from types.ts. When you click on a character, it will redirect you to a new route /character/:id, where :id is the character ID. On this route, the
