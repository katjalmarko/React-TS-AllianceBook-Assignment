  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-center items-center text-center mt-20 mb-20 text-white">
        <div className="flex justify-center items-center text-sm sm:text-base px-2 sm:px-4 py-1 sm:py-2 rounded mx-1 my-1 bg-gray-800 border-none">
          <Link
            to={'/'}
            className="text-white"
            style={{ outline: '5px solid #4a4a4a' }}
          >
            Back to Database
          </Link>
        </div>
