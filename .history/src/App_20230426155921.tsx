...
const CharacterDetails: React.FC = () => {
  ...
  return (
    <div className="flex items-center bg-black rounded-lg p-4 space-x-4">
      ...
      <div className="">
        ...
        <div className="flex flex-wrap">
          <p className="w-1/2">Height: {character.height}</p>
          <p className="w-1/2">Mass: {character.mass}</p>
          <p className="w-1/2">Hair Color: {character.hair_color}</p>
          <p className="w-1/2">Skin Color: {character.skin_color}</p>
          <p className="w-1/2">Eye Color: {character.eye_color}</p>
          <p className="w-1/2">Birth Year: {character.birth_year}</p>
          <p className="w-1/2">Gender: {character.gender}</p>
        </div>
      </div>
    </div>
  );
